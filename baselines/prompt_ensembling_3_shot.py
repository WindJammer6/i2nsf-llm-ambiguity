...
def compose_final_policy(original_intent: str, restated_intent: str, 
  ...
  |  +--rw rules* [name]
    ...
    system_prompt = (
        ...
        "Use the three supplied intent-policy examples as formatting and schema-use guidance."
